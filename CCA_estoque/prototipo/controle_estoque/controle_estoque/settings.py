...
Configurações do Django irá revelar para você tudo sobre o funcionamento do settings.
...
SECRET_KEY = 'django-insecure-8vucrd#dj%^^cg*x)i&4anyo)sbjp#cs^(_r@@jx1_v!5-&hj8'
